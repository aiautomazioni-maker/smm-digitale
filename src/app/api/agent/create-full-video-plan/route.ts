      ...
      // ... safeMode logic remains ...
        if (safeMode) {
            return NextResponse.json({
                video_project: {
                workspace_id: workspace_id || "automazioni_ai",
                project_title: "Automazioni AI - Progetto Iniziale",
                goal: "Visualizzazione Automazione",
                concept: "Progetto generato dal sistema per Automazioni AI.",
                style_keywords: ["innovazione", "tecnologia"],
              ...
              script: { hook_text: "Il futuro del marketing è qui", voiceover_text: "Benvenuto nel tuo nuovo video studio potenziato dall'AI di Automazioni AI.", on_screen_text: ["Automazioni AI"], cta_text: "Contattaci per una demo" },
              storyboard: { scenes: [{ scene_index: 1, duration_sec: 15, visual_description: "Interfaccia tecnologica attiva", camera_motion: "static", overlay_text: null, broll_needed: "none" }] },
              generation_plan: { mode: "text_to_video", prompt_en: "futuristic marketing agency office high tech", negative_prompt_en: "", inputs: { seed_media_urls: [], use_brand_palette: true }, specs: { aspect_ratio: "9:16", width: 1080, height: 1920, fps: 30, duration_sec: 15 } },
              ...
              copy: { caption: "Diamo vita alle tue idee con l'AI. #AutomazioniAI", cta: "Link in bio", hashtags: ["#automazioniai", "#marketing"], emoji_level: "medium" },
              cover_options: [{ option_index: 1, title: "Cover", hook_text: "Marketing AI", prompt_en: "cover prompt", negative_prompt_en: "", specs: { width: 1080, height: 1920, aspect_ratio: "9:16" }, thumbnail_safe_crop: { center_box_pct: 60, notes: ["Keep center"] }, overlay_plan: [] }],
              publish_jobs: targets.map((t: string) => ({ platform: t, content_type: "video", media_url: null, cover_url: null, caption: "Automazioni AI - New Post", hashtags: [], publish_at_iso: null, timezone: "Europe/Rome", requires_manual_publish: false, manual_steps: [] })),
              warnings: ["Modalità Provvisoria Attiva - Generato per Automazioni AI"]
            });
        }
...
CLIENT DATA:
- Industry: ${advanced_config.industry || 'Marketing / AI'}
- Content Type: ${advanced_config.content_type || 'Educational'}
- Marketing Goal: ${advanced_config.goal || 'Conversion'}
- Target Audience: ${advanced_config.target_audience || 'Entrepreneurs'}
...
`;
      ...
      try {
        ...
        console.error("OpenAI API Failure, falling back to Automazioni AI Project:", apiError);

          // Return the same mock project as safeMode but with a dynamic warning
          return NextResponse.json({
            video_project: {
              workspace_id: workspace_id || "automazioni_ai",
              project_title: "Automazioni AI - Progetto Fallback",
              goal: "Visualizzazione Demo",
              concept: "Il sistema ha caricato un progetto Automazioni AI perché l'AI è momentaneamente non disponibile.",
              style_keywords: ["innovazione", "tecnologia"],
              platform_targets: targets,
              specs: { aspect_ratio: "9:16", width: 1080, height: 1920, fps: 30, duration_sec: 15, max_duration_sec: 60, safe_zone: { top_px: 250, bottom_px: 420 } }
            },
            script: { hook_text: "Automazione Marketing Reale", voiceover_text: "Questo è un progetto Automazioni AI caricato in modalità di emergenza.", on_screen_text: ["Automazioni AI"], cta_text: "Scopri di più" },
            storyboard: { scenes: [{ scene_index: 1, duration_sec: 15, visual_description: "Interfaccia Automazioni AI attiva", camera_motion: "static", overlay_text: "AI", broll_needed: "none" }] },
            generation_plan: { mode: "text_to_video", prompt_en: "marketing automation visual", negative_prompt_en: "", inputs: { seed_media_urls: [], use_brand_palette: true }, specs: { aspect_ratio: "9:16", width: 1080, height: 1920, fps: 30, duration_sec: 15 } },
            editor_edl: { timeline: { duration_sec: 15, segments: [{ start_sec: 0, end_sec: 15, speed: 1.0, transition_to_next: "cut" }] }, filters: [{ name: "clean", intensity: 0.25 }], enhancement: { denoise: 0.2, sharpen: 0.15, stabilize: false, upscale: false }, text_overlays: [], subtitles: { enabled: true, mode: "phrase", burn_in: true, style: "clean", max_chars_per_line: 28, position_zone: "center" }, audio: { music_enabled: true, music_mode: "safe_library", music_keywords: ["upbeat"], ducking: true, ducking_level: "medium", manual_steps: [] } },
            copy: { caption: "Semplifica il tuo marketing con Automazioni AI.", cta: "Link in bio", hashtags: ["#automazioniai"], emoji_level: "medium" },
            cover_options: [{ option_index: 1, title: "Cover AI", hook_text: "Futuro AI", prompt_en: "cover prompt", negative_prompt_en: "", specs: { width: 1080, height: 1920, aspect_ratio: "9:16" }, thumbnail_safe_crop: { center_box_pct: 60, notes: ["Keep center"] }, overlay_plan: [] }],
            publish_jobs: targets.map((t: string) => ({ platform: t, content_type: "video", media_url: null, cover_url: null, caption: "Automazioni AI Support", hashtags: [], publish_at_iso: null, timezone: "Europe/Rome", requires_manual_publish: false, manual_steps: [] })),
            warnings: [`ERRORE_API_AI: ${apiError.message || 'Controlla configurazione'}. Caricato progetto Automazioni AI.`]
          });
        }
